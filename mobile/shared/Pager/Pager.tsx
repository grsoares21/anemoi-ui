...
import { StyleSheet, TextInput, Keyboard, I18nManager, InteractionManager, NativeMethods } from 'react-native';
...
export default class Pager<T extends Route> extends React.Component<Props<T>, ComponentState> {
  ...
  private previouslyFocusedTextInput: (Component<unknown, {}, any> & Readonly<NativeMethods>) | null = null;
  ...
  private maybeCancel = block([
    cond(
      and(
        ...
        or(
          and(eq(this.index, sub(this.routesLength, 1)), lessThan(this.gestureX, 0)), // last page, swiping left
          and(eq(this.index, 0), greaterThan(this.gestureX, 0)) // first page, swiping right
          //and(eq(this.index, 0), lessThan(this.gestureX, 0)) // first page, swiping right
