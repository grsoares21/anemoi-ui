...
const TravelPlannerWorkflow: React.FC<TravelPlannerWorkflowProps> = props => {
  ...
  const sendTravelPlanRequest = (state: State) =>
      ...
      <Container>
        <Row>
          <Col xs={{ span: 12 }} md={{ span: 8, offset: 2 }}>
            ...
            <br />
            <br />
            <WorkflowStep isVisible={workflowSection >= WorkflowSection.TravelPeriod} uniqueKey="travelPeriodWorkflow">
              <h4>{t('NOTED')}</h4>
              <h4>
            ...
            <br />
            <WorkflowStep isVisible={workflowSection >= WorkflowSection.CalculateTravelPlan} uniqueKey="calculateRoute">
              <Button
                size="lg"
                block
                ref={submitButtonRef}
            ...
            <WorkflowStep isVisible={workflowSection >= WorkflowSection.TravelPlanResult} uniqueKey="travelPlanResult">
